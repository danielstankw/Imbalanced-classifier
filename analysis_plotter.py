...
df3 = pd.read_csv("circle2_0.0009.csv")
...
#
# overlap = result[result['Case'] == 1]
# no_overlap = result[result['Case'] == 0]
# overlap_one = df11[df11['Case'] == 1]
# no_overlap_one = df11[df11['Case'] == 0]


# ['time', 'x', 'y', 'z', 'rx', 'ry', 'rz', 'Fx', 'Fy', 'Fz', 'Vx', 'Vy', 'Vz', 'Mx', 'My', 'Mz', 'Case', 't_contact', 'm_mag'],



plt.figure('Fz')
plt.plot(df11['time'],df11['Fz'], label='Switch')
plt.plot(df33['time'],df33['Fz'], label='No switch')
plt.grid()
plt.legend()
plt.xlabel('Time[sec]')
plt.ylabel('Fz[N]')
...
plt.figure('Mx')
plt.plot(df11['time'],df11['Mx'], label='Switch')
plt.plot(df33['time'],df33['Mx'], label='No switch')
plt.grid()
plt.legend()
plt.xlabel('Time[sec]')

plt.figure('My')
plt.plot(df11['time'],df11['My'], label='Switch')
plt.plot(df33['time'],df33['My'], label='No switch')
plt.grid()
plt.legend()
plt.xlabel('Time[sec]')

plt.figure('Case-switch')
plt.scatter(df11['time'],df11['Case'], label='Zones')
plt.grid()
plt.xlabel('Time[sec]')

plt.figure('Case- no switch')
plt.scatter(df33['time'],df33['Case'], label='Zones')
plt.grid()
plt.xlabel('Time[sec]')
